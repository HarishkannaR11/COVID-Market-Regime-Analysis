"""
NEUROFINANCE BRAIN SYSTEM ANALYSIS - 65/35 SPLIT
================================================

Train: 65% | Validation: 17.5% (50% of 35%) | Test: 17.5% (50% of 35%)
...
def main():
    ...
    print("="*80)
    print("NEUROFINANCE BRAIN SYSTEM ANALYSIS - 65/35 SPLIT")
    print("="*80)
    ...
    # ========================================================================
    # 3. PREPARE FEATURES AND SPLIT DATA (65/35 - NO LEAKAGE)
    # ========================================================================
    ...
    # Split Temp into Validation (17.5%) and Test (17.5%)
    ...
    os.makedirs('Results_65_35', exist_ok=True)
    ...
    perf_df.to_csv('Results_65_35/model_performance_65_35.csv', index=False)
    print("✓ Saved: Results_65_35/model_performance_65_35.csv")
    
    # Save data split info
    split_info = {
        'Split_Type': '65/35',
        'Train_Samples': len(df_train_full),
        'Train_Percentage': 65.0,
        'Validation_Samples': len(df_val),
        'Validation_Percentage': 17.5,
        'Test_Samples': len(df_test),
        'Test_Percentage': 17.5,
        'Total_Samples': len(df_combined),
        'Random_State': 42
    }
    
    split_df = pd.DataFrame([split_info])
    split_df.to_csv('Results_65_35/split_information_65_35.csv', index=False)
    print("✓ Saved: Results_65_35/split_information_65_35.csv")
    ...
    print("\n" + "="*80)
    print("ANALYSIS COMPLETE - 65/35 SPLIT")
    print("="*80)
    
    print("\nDATA SPLIT:")
    print("-" * 80)
    print(f"Training:   {len(df_train_full)} samples (65.0%)")
    print(f"Validation: {len(df_val)} samples (17.5%)")
    print(f"Test:       {len(df_test)} samples (17.5%)")
